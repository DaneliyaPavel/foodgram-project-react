    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'Пользователь с таким email уже существует!'}, help_text='Укажите свой email', max_length=254, unique=True, verbose_name='Электронная почта')),
